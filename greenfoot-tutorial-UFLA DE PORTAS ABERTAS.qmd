...
subtitle: UFLA de portas abertas - 2024
---

# Sobre o Tutorial {background-color="#40666e"}

O intuito dessa oficina será realizar um jogo com gráficos em 2D, desenvolvido em Java, com a IDE Greenfoot.
...
Baixe o projeto [greenfoot-ursos](https://github.com/ufla-ipoo/greenfoot-ursos/archive/refs/heads/main.zip) e abra-o no Greenfoot.

Aqui você pode ter alguma dificuldade em descompactar o arquivo nos computadores em Linux, chame o monitor para ajudar.
...
- As **classes** (elas são moldes que agente usa para criar objetos que vão se tornar realidade no jogo).
...
## Chamar métodos (ações dos objetos) diretamente {.smaller}
...
Baixe o projeto [greenfoot-caranguejo](https://github.com/ufla-ipoo/greenfoot-caranguejo/archive/refs/heads/main.zip) e abra-o no Greenfoot.
...
-- Verificar se vale deixar essa parte porque os computadores não rodam --
...
Baixe aqui o código completo para testar
