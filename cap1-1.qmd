...
Vamos iniciar nossa jornada no mundo da [Programação Orientada a Objetos]{.alert} (PPOO)!
...
Você verá um retângulo na parte inferior do BlueJ, chamado "círculo1".
...
- O método indica quais tipos de parâmetros ele precisa.
