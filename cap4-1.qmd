...
- Depois vamos incrementar o projeto para que ele pareça com um organizar e tocador de músicas de verdade.
...
Ainda faltam algumas coisas para nosso organizar ficar mais útil.
...
- Ex.: podemos querer buscar todas as músicas que tenham a palavra `renda` no título.
  - Mas isso pode retornar músicas de uma cantora chamado `Brenda`.
