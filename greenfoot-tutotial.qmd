...
Obs.: se o mundo não estiver aparecendo, clique no botão **Compilar** na parte inferior direita.
...
```{.java code-line-numbers="false"}
    ...
    Larva larva = getOneIntersectingObject(Larva.class);
...
- Na próxima aula aprofundaremos essa questão, ao estudarmos o conceito [coesão de métodos]{.alert}.
