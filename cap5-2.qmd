...
- Um programador poderia implementar a classe `SistemaSuporte`, por exempllo, e outro a classe `LeitorDeEntrada`.
...
- Portanto, precisamos escrever boa documentação e classes também para as nossas próprias classes.
...
- Com o código de uma classe aberto no BlueJ, podemos acessar a caixa de opções no cantos superior direito e mudar de _código-fonte_ para _documentação_.
...
A documentação de uma classe deveria incluir:
