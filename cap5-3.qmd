...
Obs.: por convenção, escrevemos os nomes das constantes com letras maiúsculas.
...
Acesse, no Campus Virtual, as atividades dessa aula e envie os códigos dos projetos 
`bolas-quicando` e `produtos-com-hashmap` da forma que ficaram após as suas alterações 
(compacte a pasta em um arquivo `.zip` para enviar).
:::
